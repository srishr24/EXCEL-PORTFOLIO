...
### Attrition Analysis (see DASH2.png)
...
- Hiring-Attrition.xlsx — full workbook (data + dashboards)
- employee_data.csv — raw dataset exported as CSV
- introduction.png — project introduction (INTRO sheet)
- DASH1.png — Hiring Analysis dashboard
- DASH2.png — Attrition Analysis dashboard
- insight.png — key insights summary
- README.md — project documentation

## 🚀 How to Use

1. Download Hiring-Attrition.xlsx.
2. Open in Excel (2016+ recommended for full Slicer/PivotChart support).
3. Navigate the sheet tabs — INTRO → P&O → DASH1 → DASH2 → INSIGHT — to follow the project flow.
4. Use the slicers on DASH1/DASH2 to filter interactively by department, age group, overtime, etc.
